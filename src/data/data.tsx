...
import profilepic from '../images/logo_transparent.webp';
...
export const contact: ContactSection = {
  ...
  description: 'Please get in touch using the below form and we will endeavour to get back to you as soon as possible.',
  items: [
    {
...
export const socialLinks: Social[] = [
  ...
  {label: 'Twitter', Icon: TwitterIcon, href: 'https://twitter.com/yellowbucketltd'},
